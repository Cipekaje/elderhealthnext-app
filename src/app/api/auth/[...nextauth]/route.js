        ...
        CredentialsProvider({
            ...
            async authorize(credentials) {
                ...
                try {
                    ...
                    const [userRows, userFields] = await pool.query('SELECT id, email, firstName, lastName, birthdate, password, role, isFirstLogin FROM User WHERE email = ?', [credentials.email]);
                    // If a user is found
